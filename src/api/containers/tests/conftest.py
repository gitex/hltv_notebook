...
from api.services.analyze import DataFramePipelineService


@pytest.fixture
def csv_analyze_container(matches_csv_repository):
    return original_analyze_container


@pytest.fixture
def csv_matches_service(csv_analyze_container) -> DataFramePipelineService:
    return csv_analyze_container.service()
